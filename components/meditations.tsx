...
function Meditations() {
  return (
    <div id="posts" className='mb-6 mt-14 md:col-span-2'>
      ...
      <p className='text-normal w-1/2 text-polar-night italic ml-auto mr-auto p-4 pb-8 text-justify'>This is my own stuff. Here, you might find my notes usually on computational finance, mathematics, programming or anything in between. This ain't organised!</p>
      <NotesPosts />
    </div>
  )
}
