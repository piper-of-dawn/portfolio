...
function Meditations() {
  return (
    <div id="posts" className='mb-6 mt-14 md:col-span-2'>
      <div className="ml-auto mr-auto font-mono font-bold border-t border-b border-dotted text-normal text-center uppercase tracking-wide p-2 w-40 pt-3 mb-5">The Joy of Chasing Intuitions</div>
