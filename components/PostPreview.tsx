...
const PostPreview = (props: PostMetaData ) => {
 ...
 <Link className="rounded-lg w-80 border relative block overflow-hidden shadow-md border-gray-100 p-2 sm:p-3 lg:p-4" href={`/posts/${props.slug}`}>
  ...
  <p className="hidden group-hover:flex flex-row text-normal font-bold m-2 ease-in duration-500">Read <Image className="m-1" src="\images\arrow-right-solid.svg" alt= "Logo" width={10} height={10} /></p>
